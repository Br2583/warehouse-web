...
export default function StorageDetailPage() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      <Sidebar />
      <main className="md:ml-64 flex-1 min-w-0 px-4 pb-8 md:px-8 md:pb-8 max-w-3xl topbar-offset">
        ...
        <AnimatePresence>
          {slotModal && (
            <div className="fixed inset-0 bg-black/40 z-[55] flex items-start md:items-center justify-center p-4" onClick={() => setSlotModal(null)}>
