...
function VaultPrintContent() {
  ...
  const checkSVG = (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#ffffff" strokeWidth="4" strokeLinecap="square">
    ...
    <>
      ...
      <style>{`
        * { box-sizing: border-box; }
        ...
        .sec     { border: 3px solid #000000; }
        .sec-mid { border: 3px solid #000000; border-top: none; }
        .sec-top { border: 3px solid #000000; border-bottom: none; }
        .div-v   { border-right: 2px solid #000000; }
        .cb {
          width: 22px; height: 22px; flex: none;
          border: 2.5px solid #000000;
          display: flex; align-items: center; justify-content: center;
        }
        .cb-on { background: #000000; }
        ...
        @media print {
          ...
          .vault-label { width: 8.5in !important; height: 11in !important; box-shadow: none !important; }
        }
      `}</style>
      ...
      {/* Label */}
      <div className="vault-label" style={{ width: '8.5in', height: '11in', padding: '0.4in', background: '#ffffff', color: '#000', display: 'flex', flexDirection: 'column' }}>
