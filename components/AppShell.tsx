...
const AUTH_ROUTES = ['/dashboard', '/warehouses', '/search', '/tasks', '/stats', '/snapshots', '/chat', '/profile', '/storage', '/onboarding', '/deleted', '/scan', '/vault', '/settings', '/support', '/push-debug', '/activity'];
